// JS setup functions
/////-----------
// <editor-fold> ---------Functions for CSS managment
...
//</editor-fold>
// <editor-fold> ---------Interaction Management
  ...
  function Button(StateNumber,Initialise,Update,Display){//Button class
  // <editor-fold>
  ...
  function Interactor(){
    this.Bi=[];// List of Buttons
    this.Fi=[];//Internal variables
    this.I=Initialise;
    this.Sup=Update;
    this.Sdis=Display;

    this.NoButtonIngaged=function(){
      var AnyStateOn=false;
      for(var i=0;i<this.Bi.length;i++){
        for(var j=0;j<this.Bi[i].B.length;j++){
          if(this.B[i].Bi[j].H===true){
            AnyStateOn=true;
          }
        }
      }
  ...
  //<editor-fold>
    ...
    // <editor-fold> Define Transition functions
    ...
    // <editor-fold> Functions on transitions
    ...
    // <editor-fold> Add and Run Trans functions
    ...
    // <editor-fold> Scroller display/css stuff
...
// <editor-fold> ---------System
  ...
  // <editor-fold>
    ...
    // <editor-fold> Connection legality checks
    ...
    // <editor-fold> Mouse contact checks
  ...
  function Person(Pos,Com){// Class for the people
  // <editor-fold>
